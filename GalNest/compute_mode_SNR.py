...
#        SNR threshold
#
# To be run on the modal output from MultiNest.
...
seed = 1
multinest_output_pkl = './data/low_snr/seed%s_14000_0.8_0.1_.pkl' % seed  # MultiNest modal output.
multinest_output_pkl_w_snr = './data/low_snr/seed%s_14000_0.8_0.1_wSNR.pkl' % seed  # MultiNest modal output w SNR.
...
with montblanc.rime_solver(slvr_cfg) as slvr:
    ...
    data = pd.read_pickle(multinest_output_pkl)
    ...
    df['SNR'] = modes_SNR
    with open(multinest_output_pkl_w_snr, 'wb') as f:
        pickle.dump(df, f)
